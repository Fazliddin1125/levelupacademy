...
const trav = document.querySelector('.section-title')
const text = document.querySelector('.hero-text')
const wrapper = document.querySelector('.wrapper-one')
let num = 0;
const wrapperimg = () => {
  setInterval(() => {
 ...
 if (num === 0) {
      ...
      wrapper.style.backgroundImage = "url('staticfiles/images/white.jpg')";
      num = 1
    } else if (num === 1) {
      
      trav.innerHTML = "Once you stop learning, you start dying"
      text.innerHTML = "Learning, it robs us of our potential. Developing ourselves and learning new knowledge at every step, we can fill our lives with more colorful and spiritual indicators."
      wrapper.style.backgroundImage = "url('/staticfiles/images/white3.jpg')";
      num = 2
    } else if (num === 2) {
      ...
      wrapper.style.backgroundImage = "url('staticfiles/images/white2.jpg')";
      num = 0
    }
